...
<head>
	...
	<link href="http://fonts.wsj.net/HCo_Whitney/font_HCo_Whitney.css" rel="stylesheet" type="text/css" />
	<link href="http://fonts.wsj.net/HCo_Chronicle/font_HCo_Chronicle.css" rel="stylesheet" type="text/css" />
	<!--[if lte IE 9]>
		<link href="http://fonts.wsj.net/HCo_Whitney/font_HCo_Whitney-ie.css" rel="stylesheet" type="text/css" />
		<link href="http://fonts.wsj.net/HCo_Chronicle/font_HCo_Chronicle-ie.css" rel="stylesheet" type="text/css" />
	<![endif]-->
	<link rel="stylesheet" href="http://graphics.wsj.com/libs/css/bootstrap/3.3.2/bootstrap.min.css">
	<link rel="stylesheet" href="http://graphics.wsj.com/libs/css/wsj/jquery.socialriser/1.4.0/jquery.socialriser.css"/>
...
<body class="" onunload="window.speechSynthesis.cancel()">
		...
		<section class="container container-wide">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h4 class="center-text tight-lines now-playing-title">Title here</h4>
					
                    <p class="center-text gray">Note: This demo only works correctly on iOS Safari. <a href="https://github.com/ejb/DriveTime">Fork it on GitHub!</a></p>
	...
	<script src="http://graphics.wsj.com/libs/js/wsj/wsj-template/1.2.0/common.js"></script>
